...
import {
  useCreateMutation,
  useGetAllQuery as useGetAllDhm2Query, useGetAllTest2Query, useRemoveMutation, useUpdateMutation,
...
import {StrategiesDhmDialog} from "@/src/sections/strategies-graph-test2/strategies.dhm-dialog";
import {IconButton} from "@mui/material";
import SpeedIcon from '@mui/icons-material/Speed';
import SettingsIcon from '@mui/icons-material/Settings';
import {StrategiesDhmBacktestDialog} from "@/src/sections/strategies-graph-test2/strategies.dhm-backtest-dialog";
//import {StrategiesDhmSettingsDialog} from "@/src/sections/strategies-graph-test2/strategies.dhm-settings-dialog";
import {StrategiesDhmFppFiltersDialog} from "@/src/sections/strategies-graph-test2/strategies.dhm-fpp-filters-dialog";
import {StrategiesDhmKlineFppsDialog} from "@/src/sections/strategies-graph-test2/strategies.dhm-kline-fpps-dialog";
...
export default function DhmIndexView({ tf, pairId }: any) {
  ...
  const { data: testDhm } = useGetAllTest2Query({ pairId, tf: 60 });
